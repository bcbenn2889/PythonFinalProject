...
env.workspace = "G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2"
## Create new shape file using desired coordinates for dimensions
fc = "Test_AOI_2.shp"
newfc= "Data/Test_AOI_2.shp"
arcpy.CreateFeatureclass_management("G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2", fc, "Polygon")
cursor = arcpy.da.InsertCursor(fc, ["SHAPE@"])
array = arcpy.Array()
## Predetermined coordinates of AOI [x,y] for each corner.
            #TL                          BL                         BR                         TR
coordlist =[[2363510.656, 1552950.7], [2363594.238, 1552031.291], [2364549.309, 1552118.217], [2364463.498,1553038.741]]
...
# Save the output 
outExtractByMask.save("G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\extractmask_Lake.tif")
...
outUnsupervised.save("G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\UNSUP_ISO_CLUS_Lake.tif")

# Raster to Polygon tool
# Set local variables
inRaster = "UNSUP_ISO_CLUS_Lake.tif"
outPolygons = "G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\Polygons.shp"
field = "VALUE"
...
# Save the output 
attExtract.save("G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\WaterExtract.tif")

# Raster to Polygon tool for water extract file
# Set local variables
inRaster = "WaterExtract.tif"
outPolygons = "G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\WEXPolygon.shp"
field = "VALUE"
...
arcpy.MakeFeatureLayer_management("G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\WEXPolygon.shp", "shade_lyr")
##fieldDelimited = arcpy.ListFields("shade_lyr")
##print([field.name for field in fieldDelimited])
arcpy.SelectLayerByLocation_management ("shade_lyr", "intersect", "G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\WEXPolygon.shp",0,"new_selection")
...
arcpy.MakeFeatureLayer_management("G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\Polygons.shp", "new_shade_lyr")

# Then add a selection to the layer based on location to features in another feature class 
arcpy.SelectLayerByLocation_management ("new_shade_lyr", "intersect", "G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\Shade_water.shp",0,"new_selection")
...
arcpy.MakeFeatureLayer_management("G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\Shade_water_Final.shp", "sw_lyr")
arcpy.SelectLayerByLocation_management ("sw_lyr", "intersect", "G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\Shade_Water_Final.shp",0,"new_selection")
...
arcpy.Dissolve_management("SWFinal.shp", "G:\School\Personal Drive\Fall2014\Python\Project\Test\Test2\SWFinal_Dissolved.shp",
                          ["GRIDCODE"], "", "MULTI_PART", 
                          "DISSOLVE_LINES")
